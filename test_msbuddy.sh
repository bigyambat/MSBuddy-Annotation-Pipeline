...
echo ""
echo "Pipeline Configuration Notes:"
echo "  - MSBuddy is now configured to output detailed fragment annotations"
echo "  - Default instrument type: orbitrap"
echo "  - Override with: --ms_instrument_type qtof|orbitrap|fticr"
echo "  - Example: nextflow run main.nf --input 'data/*.mgf' --ms_instrument_type qtof"
echo ""
